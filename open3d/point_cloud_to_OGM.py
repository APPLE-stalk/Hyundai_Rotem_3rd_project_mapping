...
lidar_data_path = '../lidar_data(100_100)'      #'C:/Users/pizza/Documents/Tank Challenge/lidar_data'
...
print(f'100x100맵의 point cloud csv파일 읽는데 걸리는 시간: {ed_time - st_time:.6f}초')
...
# o3d.io.write_point_cloud("flat(100x100)_pc_raw_visual.ply", pcd)
...
for v in voxels:
    ...
    occ[i, j, k] = 1
ed_time = time.perf_counter()
print(f'voxelgrid 변환 소요시간: {ed_time - st_time:.6f}초')
